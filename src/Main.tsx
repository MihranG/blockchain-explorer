...
const Main:FC<{}> = () =>{
    ...
    return <Row className="justify-content-md-center m-5">
        <Form onSubmit={onSubmit}>
            <Form.Group>
                ...
                <InputGroup className="mb-3">
                    ...
                    <Form.Control size="lg" type="text" placeholder="block number" value={value} onChange={(e)=>setValue(e.target.value)}/>
                    <InputGroup.Append>
